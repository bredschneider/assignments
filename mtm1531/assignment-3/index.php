...
<?php else : ?>
		<form method="post" action="index.php">
			...
			<div>
				<input type="checkbox" id="terms" name="terms" value="1"><?php if (isset($_POST['terms'])) { echo 'checked';}?>
               <label for="terms">I have read and accept terms?</label><?php if(isset($error_msg['terms'])) : ?><strong class="error">You must comply!</strong><?php endif;?>
			</div>
